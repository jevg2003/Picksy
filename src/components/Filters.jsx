...
export const SocialIcons = () => (
  <div className=" p-4 flex justify-center space-x-9 ">
    {/* Facebook */}
    <a
    ...
    <a
      ...
      className="text-gray-700 dark:text-white hover:text-green-500 dark:hover:text-green-400"
      target="_blank"
      rel="noopener noreferrer"
    >
    ...
    <a
      ...
      className="text-gray-700 dark:text-white hover:text-pink-500 dark:hover:text-pink-400"
      target="_blank"
      rel="noopener noreferrer"
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="currentColor">
    ...
    <a
      ...
      className="text-gray-700 dark:text-white hover:text-blue-400 dark:hover:text-blue-300"
      target="_blank"
      rel="noopener noreferrer"
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="currentColor">
