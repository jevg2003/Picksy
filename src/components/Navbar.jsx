              ...
              >
                <div className="relative w-6 h-6">
                  {['system', 'dark', 'light'].map((theme) => (
                    ...
                    >
                      {theme === 'system' && <Monitor size={22} className="text-gray-900 dark:text-white"/>}
                      {theme === 'dark' && <Moon size={22} className="text-gray-900 dark:text-white"/>}
                      {theme === 'light' && <Sun size={22} className="text-gray-900 dark:text-white"/>}
                    </div>
                  ))}
                </div>
              </button>
